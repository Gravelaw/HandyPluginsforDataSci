...
- Use icons intentionally as semantic labels or mode markers. Keep one icon family and stroke weight.
...
- A deck over 8 slides should not be text-and-shape-only unless the user explicitly requests a barebones draft.
